...
public class ThreePlayerActivity extends AppCompatActivity {
    int[] bod = new int[]{0,0,0};
    int[] bod_undo = new int[]{0,0,0};
    TextView[] tvBod=new TextView[3];
    TextView[] tvIme=new TextView[3];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvBod[0]=findViewById(R.id.tritvbodoviprvog);
        tvBod[1]=findViewById(R.id.tritvbodovidrugog);
        tvBod[2]=findViewById(R.id.tritvbodovitreceg);
        


        tvIme[0]=findViewById(R.id.tritvimeprvog);
        tvIme[1]=findViewById(R.id.tritvimedrugog);
        tvIme[2]=findViewById(R.id.tritvimetreceg);
    ...
    public void unosBodova(View v){
        ...
        LayoutInflater inflater = ThreePlayerActivity.this.getLayoutInflater();
        builder.setView(R.layout.dialog3bodovi);
        //In case it gives you an error for setView(View) try
        final View customLayout = getLayoutInflater().inflate(R.layout.dialog3bodovi, null);
        builder.setView(customLayout);
        final AlertDialog show=builder.show();
        EditText[] etBod=new EditText[3];
        ...
        final EditText FinalFocus=customLayout.findViewById(R.id.editText3);
    ...
    void unosImena(){
        ...
        builder.setView(R.layout.dialogtriimena);
        //In case it gives you an error for setView(View) try
        final View customLayout = getLayoutInflater().inflate(R.layout.dialogtriimena, null);
        builder.setView(customLayout);
        final AlertDialog show=builder.show();
        final EditText focus=customLayout.findViewById(R.id.editText);
